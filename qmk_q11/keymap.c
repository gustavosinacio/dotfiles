...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [SWITCH_0] = LAYOUT_91_ansi(
        ...
        MO(MOD3),   MT(MOD_LCTL,KC_ESC),  KC_A,      KC_S,     KC_D,     LT(MOD3, KC_F),  KC_G,      KC_H,     KC_J,              KC_K,     KC_L,        KC_SCLN,  KC_QUOT,  KC_ENT,                       KC_HOME,
        MO(SW1F),   KC_LSFT,              KC_Z,      KC_X,     KC_C,     KC_V,            KC_B,      KC_N,     KC_M,              KC_COMM,  KC_DOT,      KC_SLSH,  KC_RSFT,  KC_UP,
        DB_TOGG,    KC_LCTL,              MO(MOD1),  KC_LWIN,  KC_LALT,                   LT(MOD2, KC_SPC),    LT(MOD1, KC_BSPC), MO(MOD3), KC_RWIN,     KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MOD1] = LAYOUT_91_ansi(
        ...
        _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,      KC_7,        MS_WHLU,          KC_9,       KC_0,         KC_MINS,  KC_EQL,     _______,  _______,            _______,
        _______,  _______,  _______,  _______,  MS_WHLD,  _______,  _______,   KC_MS_LEFT,  KC_MS_DOWN,    KC_MS_UP,   KC_MS_RIGHT,  _______,  _______,              _______,            _______,
    ...
    [MOD2] = LAYOUT_91_ansi(
        RGB_TOG,  _______,  KC_F1,    KC_F2,    KC_F3,       KC_F4,       KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,     KC_F10,   KC_F11,     KC_F12,   _______,  _______,  RGB_TOG,
        _______,  _______,  _______,  _______,  _______,     _______,     _______,  _______,  _______,  _______,  _______,   _______,  _______,    _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,     _______,     _______,  _______,  MS_WHLU,  _______,  _______,   _______,  _______,    _______,  _______,            _______,
        _______,  _______,  _______,  _______,  MS_WHLD,     KC_F,        _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT,  _______,  _______,              _______,            _______,
        _______,  _______,            _______,  _______,     _______,     KC_B,     _______,  NK_TOGG,  _______,  _______,   _______,  _______,              _______,  _______,
        _______,  _______,  _______,  _______,  _______,                  _______,            _______,            _______,   _______,  _______,    _______,  _______,  _______),
